...
{if $homeslider.slides}
  <div id="carousel" data-ride="carousel" class="carousel slide" data-interval="{$homeslider.speed}" data-wrap="{(string)$homeslider.wrap}" data-pause="{$homeslider.pause}" data-touch="true">
    ...
    <div class="direction" aria-label="{l s='Carousel buttons' d='Shop.Theme.Global'}">
      <span class="left carousel-control" role="button" style="cursor:pointer" data-target="#carousel" data-slide="prev" aria-label="{l s='Previous' d='Shop.Theme.Global'}">
        <span class="icon-prev hidden-xs" aria-hidden="true">
          <i class="material-icons">&#xE5CB;</i>
        </span>
      </span>
      <span class="right carousel-control" role="button" style="cursor:pointer" data-target="#carousel" data-slide="next" aria-label="{l s='Next' d='Shop.Theme.Global'}">
